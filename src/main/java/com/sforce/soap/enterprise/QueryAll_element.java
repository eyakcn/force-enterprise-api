...
public class QueryAll_element implements com.sforce.ws.bind.XMLizable {
	...
	/**
	 * * element : queryString of type {http://www.w3.org/2001/XMLSchema}string * java
	 * type: java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo queryString__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "queryString", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.verifyElement(__in, queryString__typeInfo)) {
			setQueryString((java.lang.String) __typeMapper.readString(__in, queryString__typeInfo,
