...
public class ProcessResult implements com.sforce.ws.bind.XMLizable {
	...
	/**
	 * * element : actorIds of type {urn:enterprise.soap.sforce.com}ID * java type:
	 * java.lang.String[]
	 */
	private static final com.sforce.ws.bind.TypeInfo actorIds__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "actorIds", "urn:enterprise.soap.sforce.com", "ID", 0, -1, true);
	...
	/**
	 * * element : entityId of type {urn:enterprise.soap.sforce.com}ID * java type:
	 * java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo entityId__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "entityId", "urn:enterprise.soap.sforce.com", "ID", 1, 1, true);
	...
	/**
	 * * element : errors of type {urn:enterprise.soap.sforce.com}Error * java type:
	...
	private static final com.sforce.ws.bind.TypeInfo errors__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "errors", "urn:enterprise.soap.sforce.com", "Error", 0, -1, true);
	...
	/**
	 * * element : instanceId of type {urn:enterprise.soap.sforce.com}ID * java type:
	 * java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo instanceId__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "instanceId", "urn:enterprise.soap.sforce.com", "ID", 1, 1, true);
	...
	/**
	 * * element : instanceStatus of type {http://www.w3.org/2001/XMLSchema}string * java
	 * type: java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo instanceStatus__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "instanceStatus", "http://www.w3.org/2001/XMLSchema", "string", 1, 1,
			true);
	...
	/**
	 * * element : newWorkitemIds of type {urn:enterprise.soap.sforce.com}ID * java type:
	 * java.lang.String[]
	 */
	private static final com.sforce.ws.bind.TypeInfo newWorkitemIds__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "newWorkitemIds", "urn:enterprise.soap.sforce.com", "ID", 0, -1, true);
	...
	/**
	 * * element : success of type {http://www.w3.org/2001/XMLSchema}boolean * java type:
	 * boolean
	 */
	private static final com.sforce.ws.bind.TypeInfo success__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "success", "http://www.w3.org/2001/XMLSchema", "boolean", 1, 1, true);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.isElement(__in, actorIds__typeInfo)) {
			setActorIds((java.lang.String[]) __typeMapper
					.readObject(__in, actorIds__typeInfo, java.lang.String[].class));
		}
		__in.peekTag();
		...
		if (__typeMapper.isElement(__in, errors__typeInfo)) {
			setErrors((com.sforce.soap.enterprise.Error[]) __typeMapper.readObject(__in, errors__typeInfo,
					com.sforce.soap.enterprise.Error[].class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, instanceId__typeInfo)) {
			setInstanceId((java.lang.String) __typeMapper
					.readString(__in, instanceId__typeInfo, java.lang.String.class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, instanceStatus__typeInfo)) {
			setInstanceStatus((java.lang.String) __typeMapper.readString(__in, instanceStatus__typeInfo,
					java.lang.String.class));
		}
		__in.peekTag();
		if (__typeMapper.isElement(__in, newWorkitemIds__typeInfo)) {
			setNewWorkitemIds((java.lang.String[]) __typeMapper.readObject(__in, newWorkitemIds__typeInfo,
					java.lang.String[].class));
		}
		__in.peekTag();
