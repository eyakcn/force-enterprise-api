...
public class RelatedList implements com.sforce.ws.bind.XMLizable {
	 ...
	 */
	private static final com.sforce.ws.bind.TypeInfo columns__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "columns", "urn:enterprise.soap.sforce.com", "RelatedListColumn", 1, -1,
			true);
	...
	/**
	 * * element : field of type {http://www.w3.org/2001/XMLSchema}string * java type:
	 * java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo field__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "field", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
	...
	/**
	 * * element : limitRows of type {http://www.w3.org/2001/XMLSchema}int * java type:
	 * int
	 */
	private static final com.sforce.ws.bind.TypeInfo limitRows__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "limitRows", "http://www.w3.org/2001/XMLSchema", "int", 1, 1, true);
	...
	/**
	 * * element : sobject of type {http://www.w3.org/2001/XMLSchema}string * java type:
	 * java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo sobject__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "sobject", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
	...
	/**
	 * * element : sort of type {urn:enterprise.soap.sforce.com}RelatedListSort * java
	 * type: com.sforce.soap.enterprise.RelatedListSort[]
	 */
	private static final com.sforce.ws.bind.TypeInfo sort__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "sort", "urn:enterprise.soap.sforce.com", "RelatedListSort", 0, -1, true);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.verifyElement(__in, columns__typeInfo)) {
			setColumns((com.sforce.soap.enterprise.RelatedListColumn[]) __typeMapper.readObject(__in,
					columns__typeInfo, com.sforce.soap.enterprise.RelatedListColumn[].class));
		}
		__in.peekTag();
		...
		if (__typeMapper.isElement(__in, sort__typeInfo)) {
			setSort((com.sforce.soap.enterprise.RelatedListSort[]) __typeMapper.readObject(__in, sort__typeInfo,
					com.sforce.soap.enterprise.RelatedListSort[].class));
		}
	}
