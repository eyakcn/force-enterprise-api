...
public class LeadConvert implements com.sforce.ws.bind.XMLizable {
	...
	/**
	 * * element : accountId of type {urn:enterprise.soap.sforce.com}ID * java type:
	 * java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo accountId__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "accountId", "urn:enterprise.soap.sforce.com", "ID", 1, 1, true);
	...
	/**
	 * * element : contactId of type {urn:enterprise.soap.sforce.com}ID * java type:
	 * java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo contactId__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "contactId", "urn:enterprise.soap.sforce.com", "ID", 1, 1, true);
	...
	/**
	 * * element : convertedStatus of type {http://www.w3.org/2001/XMLSchema}string * java
	 * type: java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo convertedStatus__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "convertedStatus", "http://www.w3.org/2001/XMLSchema", "string", 1, 1,
			true);
	...
	/**
	 * * element : doNotCreateOpportunity of type
	...
	private static final com.sforce.ws.bind.TypeInfo doNotCreateOpportunity__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "doNotCreateOpportunity", "http://www.w3.org/2001/XMLSchema", "boolean",
			1, 1, true);
	...
	/**
	 * * element : leadId of type {urn:enterprise.soap.sforce.com}ID * java type:
	 * java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo leadId__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "leadId", "urn:enterprise.soap.sforce.com", "ID", 1, 1, true);
	...
	/**
	 * * element : opportunityName of type {http://www.w3.org/2001/XMLSchema}string * java
	 * type: java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo opportunityName__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "opportunityName", "http://www.w3.org/2001/XMLSchema", "string", 1, 1,
			true);
	...
	private static final com.sforce.ws.bind.TypeInfo overwriteLeadSource__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "overwriteLeadSource", "http://www.w3.org/2001/XMLSchema", "boolean", 1,
			1, true);
	...
	/**
	 * * element : ownerId of type {urn:enterprise.soap.sforce.com}ID * java type:
	 * java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo ownerId__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "ownerId", "urn:enterprise.soap.sforce.com", "ID", 1, 1, true);
	...
	private static final com.sforce.ws.bind.TypeInfo sendNotificationEmail__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "sendNotificationEmail", "http://www.w3.org/2001/XMLSchema", "boolean",
			1, 1, true);
	...
	protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		__typeMapper.writeBoolean(__out, doNotCreateOpportunity__typeInfo, doNotCreateOpportunity,
				doNotCreateOpportunity__is_set);
		...
		__typeMapper.writeBoolean(__out, overwriteLeadSource__typeInfo, overwriteLeadSource,
				overwriteLeadSource__is_set);
		__typeMapper.writeString(__out, ownerId__typeInfo, ownerId, ownerId__is_set);
		__typeMapper.writeBoolean(__out, sendNotificationEmail__typeInfo, sendNotificationEmail,
				sendNotificationEmail__is_set);
	}
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.verifyElement(__in, convertedStatus__typeInfo)) {
			setConvertedStatus((java.lang.String) __typeMapper.readString(__in, convertedStatus__typeInfo,
					java.lang.String.class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, doNotCreateOpportunity__typeInfo)) {
			setDoNotCreateOpportunity((boolean) __typeMapper.readBoolean(__in, doNotCreateOpportunity__typeInfo,
					boolean.class));
		}
		__in.peekTag();
		...
		if (__typeMapper.verifyElement(__in, opportunityName__typeInfo)) {
			setOpportunityName((java.lang.String) __typeMapper.readString(__in, opportunityName__typeInfo,
					java.lang.String.class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, overwriteLeadSource__typeInfo)) {
			setOverwriteLeadSource((boolean) __typeMapper.readBoolean(__in, overwriteLeadSource__typeInfo,
					boolean.class));
		}
		__in.peekTag();
		...
		if (__typeMapper.verifyElement(__in, sendNotificationEmail__typeInfo)) {
			setSendNotificationEmail((boolean) __typeMapper.readBoolean(__in, sendNotificationEmail__typeInfo,
					boolean.class));
		}
	}
