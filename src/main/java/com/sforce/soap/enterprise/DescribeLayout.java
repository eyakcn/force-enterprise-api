...
public class DescribeLayout implements com.sforce.ws.bind.XMLizable {
	...
	/**
	 * * element : buttonLayoutSection of type
	 * {urn:enterprise.soap.sforce.com}DescribeLayoutButtonSection * java type:
	...
	private static final com.sforce.ws.bind.TypeInfo buttonLayoutSection__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "buttonLayoutSection", "urn:enterprise.soap.sforce.com",
			"DescribeLayoutButtonSection", 0, 1, true);
	...
	/**
	 * * element : detailLayoutSections of type
	 * {urn:enterprise.soap.sforce.com}DescribeLayoutSection * java type:
	...
	private static final com.sforce.ws.bind.TypeInfo detailLayoutSections__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "detailLayoutSections", "urn:enterprise.soap.sforce.com",
			"DescribeLayoutSection", 0, -1, true);
	...
	/**
	 * * element : editLayoutSections of type
	 * {urn:enterprise.soap.sforce.com}DescribeLayoutSection * java type:
	 * com.sforce.soap.enterprise.DescribeLayoutSection[]
	 */
	private static final com.sforce.ws.bind.TypeInfo editLayoutSections__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "editLayoutSections", "urn:enterprise.soap.sforce.com",
			"DescribeLayoutSection", 0, -1, true);
	...
	private static final com.sforce.ws.bind.TypeInfo id__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "id", "urn:enterprise.soap.sforce.com", "ID", 1, 1, true);
	...
	/**
	 * * element : relatedLists of type {urn:enterprise.soap.sforce.com}RelatedList * java
	 * type: com.sforce.soap.enterprise.RelatedList[]
	 */
	private static final com.sforce.ws.bind.TypeInfo relatedLists__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "relatedLists", "urn:enterprise.soap.sforce.com", "RelatedList", 0, -1,
			true);
	...
	protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		__typeMapper
				.writeObject(__out, buttonLayoutSection__typeInfo, buttonLayoutSection, buttonLayoutSection__is_set);
		__typeMapper.writeObject(__out, detailLayoutSections__typeInfo, detailLayoutSections,
				detailLayoutSections__is_set);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.isElement(__in, buttonLayoutSection__typeInfo)) {
			setButtonLayoutSection((com.sforce.soap.enterprise.DescribeLayoutButtonSection) __typeMapper.readObject(
					__in, buttonLayoutSection__typeInfo, com.sforce.soap.enterprise.DescribeLayoutButtonSection.class));
		}
		__in.peekTag();
		if (__typeMapper.isElement(__in, detailLayoutSections__typeInfo)) {
			setDetailLayoutSections((com.sforce.soap.enterprise.DescribeLayoutSection[]) __typeMapper.readObject(__in,
					detailLayoutSections__typeInfo, com.sforce.soap.enterprise.DescribeLayoutSection[].class));
		}
		__in.peekTag();
		if (__typeMapper.isElement(__in, editLayoutSections__typeInfo)) {
			setEditLayoutSections((com.sforce.soap.enterprise.DescribeLayoutSection[]) __typeMapper.readObject(__in,
					editLayoutSections__typeInfo, com.sforce.soap.enterprise.DescribeLayoutSection[].class));
		}
		__in.peekTag();
		...
		if (__typeMapper.isElement(__in, relatedLists__typeInfo)) {
			setRelatedLists((com.sforce.soap.enterprise.RelatedList[]) __typeMapper.readObject(__in,
					relatedLists__typeInfo, com.sforce.soap.enterprise.RelatedList[].class));
		}
	}
