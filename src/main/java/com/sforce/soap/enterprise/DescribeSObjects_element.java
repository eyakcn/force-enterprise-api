...
public class DescribeSObjects_element implements com.sforce.ws.bind.XMLizable {
	...
	private static final com.sforce.ws.bind.TypeInfo sObjectType__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "sObjectType", "http://www.w3.org/2001/XMLSchema", "string", 0, 100, true);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.isElement(__in, sObjectType__typeInfo)) {
			setSObjectType((java.lang.String[]) __typeMapper.readObject(__in, sObjectType__typeInfo,
