...
public class ProcessWorkitemRequest extends com.sforce.soap.enterprise.ProcessRequest {
	...
	/**
	 * * element : action of type {http://www.w3.org/2001/XMLSchema}string * java type:
	 * java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo action__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "action", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
	...
	/**
	 * * element : workitemId of type {urn:enterprise.soap.sforce.com}ID * java type:
	 * java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo workitemId__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "workitemId", "urn:enterprise.soap.sforce.com", "ID", 1, 1, true);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.verifyElement(__in, workitemId__typeInfo)) {
			setWorkitemId((java.lang.String) __typeMapper
					.readString(__in, workitemId__typeInfo, java.lang.String.class));
		}
	}
