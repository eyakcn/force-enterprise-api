...
public class LoginResult implements com.sforce.ws.bind.XMLizable {
	 ...
	 */
	private static final com.sforce.ws.bind.TypeInfo metadataServerUrl__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "metadataServerUrl", "http://www.w3.org/2001/XMLSchema", "string", 1, 1,
			true);
	 ...
	 * java type: boolean
	 */
	private static final com.sforce.ws.bind.TypeInfo passwordExpired__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "passwordExpired", "http://www.w3.org/2001/XMLSchema", "boolean", 1, 1,
			true);
	...
	/**
	 * * element : sandbox of type {http://www.w3.org/2001/XMLSchema}boolean * java type:
	 * boolean
	 */
	private static final com.sforce.ws.bind.TypeInfo sandbox__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "sandbox", "http://www.w3.org/2001/XMLSchema", "boolean", 1, 1, true);
	...
	/**
	 * * element : serverUrl of type {http://www.w3.org/2001/XMLSchema}string * java type:
	 * java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo serverUrl__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "serverUrl", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
	...
	/**
	 * * element : sessionId of type {http://www.w3.org/2001/XMLSchema}string * java type:
	 * java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo sessionId__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "sessionId", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
	 ...
	 */
	private static final com.sforce.ws.bind.TypeInfo userInfo__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "userInfo", "urn:enterprise.soap.sforce.com", "GetUserInfoResult", 0, 1,
			true);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.verifyElement(__in, metadataServerUrl__typeInfo)) {
			setMetadataServerUrl((java.lang.String) __typeMapper.readString(__in, metadataServerUrl__typeInfo,
		...
		if (__typeMapper.isElement(__in, userInfo__typeInfo)) {
			setUserInfo((com.sforce.soap.enterprise.GetUserInfoResult) __typeMapper.readObject(__in,
					userInfo__typeInfo, com.sforce.soap.enterprise.GetUserInfoResult.class));
		}
	}
