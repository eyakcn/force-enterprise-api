...
public class AllowFieldTruncationHeader_element extends com.sforce.ws.bind.SoapHeaderObject implements com.sforce.ws.bind.XMLizable {
	...
	private static final com.sforce.ws.bind.TypeInfo allowFieldTruncation__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "allowFieldTruncation", "http://www.w3.org/2001/XMLSchema", "boolean", 1,
			1, true);
	...
	protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		__typeMapper.writeBoolean(__out, allowFieldTruncation__typeInfo, allowFieldTruncation,
				allowFieldTruncation__is_set);
	}
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.verifyElement(__in, allowFieldTruncation__typeInfo)) {
			setAllowFieldTruncation((boolean) __typeMapper.readBoolean(__in, allowFieldTruncation__typeInfo,
					boolean.class));
		}
	}
