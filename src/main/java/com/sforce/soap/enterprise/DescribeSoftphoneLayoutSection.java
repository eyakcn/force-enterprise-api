...
public class DescribeSoftphoneLayoutSection implements com.sforce.ws.bind.XMLizable {
	...
	/**
	 * * element : entityApiName of type {http://www.w3.org/2001/XMLSchema}string * java
	 * type: java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo entityApiName__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "entityApiName", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
	...
	/**
	 * * element : items of type
	 * {urn:enterprise.soap.sforce.com}DescribeSoftphoneLayoutItem * java type:
	 * com.sforce.soap.enterprise.DescribeSoftphoneLayoutItem[]
	 */
	private static final com.sforce.ws.bind.TypeInfo items__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "items", "urn:enterprise.soap.sforce.com", "DescribeSoftphoneLayoutItem",
			1, -1, true);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.verifyElement(__in, entityApiName__typeInfo)) {
			setEntityApiName((java.lang.String) __typeMapper.readString(__in, entityApiName__typeInfo,
					java.lang.String.class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, items__typeInfo)) {
			setItems((com.sforce.soap.enterprise.DescribeSoftphoneLayoutItem[]) __typeMapper.readObject(__in,
					items__typeInfo, com.sforce.soap.enterprise.DescribeSoftphoneLayoutItem[].class));
		}
	}
