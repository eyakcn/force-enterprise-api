...
public class UserTerritoryDeleteHeader_element extends com.sforce.ws.bind.SoapHeaderObject implements com.sforce.ws.bind.XMLizable {
	...
	/**
	 * * element : transferToUserId of type {urn:enterprise.soap.sforce.com}ID * java
	 * type: java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo transferToUserId__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "transferToUserId", "urn:enterprise.soap.sforce.com", "ID", 1, 1, true);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.verifyElement(__in, transferToUserId__typeInfo)) {
			setTransferToUserId((java.lang.String) __typeMapper.readString(__in, transferToUserId__typeInfo,
