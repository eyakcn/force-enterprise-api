...
public class Search_element implements com.sforce.ws.bind.XMLizable {
	...
	/**
	 * * element : searchString of type {http://www.w3.org/2001/XMLSchema}string * java
	 * type: java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo searchString__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "searchString", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.verifyElement(__in, searchString__typeInfo)) {
			setSearchString((java.lang.String) __typeMapper.readString(__in, searchString__typeInfo,
