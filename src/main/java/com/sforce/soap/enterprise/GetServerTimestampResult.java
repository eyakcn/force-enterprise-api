...
public class GetServerTimestampResult implements com.sforce.ws.bind.XMLizable {
	...
	/**
	 * * element : timestamp of type {http://www.w3.org/2001/XMLSchema}dateTime * java
	 * type: java.util.Calendar
	 */
	private static final com.sforce.ws.bind.TypeInfo timestamp__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "timestamp", "http://www.w3.org/2001/XMLSchema", "dateTime", 1, 1, true);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.verifyElement(__in, timestamp__typeInfo)) {
			setTimestamp((java.util.Calendar) __typeMapper.readObject(__in, timestamp__typeInfo,
