...
public class DataCategoryGroupSobjectTypePair implements com.sforce.ws.bind.XMLizable {
	 ...
	 */
	private static final com.sforce.ws.bind.TypeInfo dataCategoryGroupName__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "dataCategoryGroupName", "http://www.w3.org/2001/XMLSchema", "string", 1,
			1, true);
	...
	protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		__typeMapper.writeString(__out, dataCategoryGroupName__typeInfo, dataCategoryGroupName,
				dataCategoryGroupName__is_set);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.verifyElement(__in, dataCategoryGroupName__typeInfo)) {
			setDataCategoryGroupName((java.lang.String) __typeMapper.readString(__in, dataCategoryGroupName__typeInfo,
