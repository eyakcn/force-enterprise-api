...
public class DescribeSoftphoneScreenPopOption implements com.sforce.ws.bind.XMLizable {
	...
	/**
	 * * element : matchType of type {http://www.w3.org/2001/XMLSchema}string * java type:
	 * java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo matchType__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "matchType", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
	...
	/**
	 * * element : screenPopData of type {http://www.w3.org/2001/XMLSchema}string * java
	 * type: java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo screenPopData__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "screenPopData", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
	...
	/**
	 * * element : screenPopType of type {http://www.w3.org/2001/XMLSchema}string * java
	 * type: java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo screenPopType__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "screenPopType", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.verifyElement(__in, screenPopData__typeInfo)) {
			setScreenPopData((java.lang.String) __typeMapper.readString(__in, screenPopData__typeInfo,
					java.lang.String.class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, screenPopType__typeInfo)) {
			setScreenPopType((java.lang.String) __typeMapper.readString(__in, screenPopType__typeInfo,
					java.lang.String.class));
		}
	}
