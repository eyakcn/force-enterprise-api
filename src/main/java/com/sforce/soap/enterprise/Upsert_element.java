...
public class Upsert_element implements com.sforce.ws.bind.XMLizable {
	 ...
	 */
	private static final com.sforce.ws.bind.TypeInfo externalIDFieldName__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "externalIDFieldName", "http://www.w3.org/2001/XMLSchema", "string", 1,
			1, true);
	...
	/**
	 * * element : sObjects of type {urn:sobject.enterprise.soap.sforce.com}sObject * java
	...
	private static final com.sforce.ws.bind.TypeInfo sObjects__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "sObjects", "urn:sobject.enterprise.soap.sforce.com", "sObject", 0, -1,
			true);
	...
	protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		__typeMapper
				.writeString(__out, externalIDFieldName__typeInfo, externalIDFieldName, externalIDFieldName__is_set);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.verifyElement(__in, externalIDFieldName__typeInfo)) {
			setExternalIDFieldName((java.lang.String) __typeMapper.readString(__in, externalIDFieldName__typeInfo,
					java.lang.String.class));
		}
		__in.peekTag();
		if (__typeMapper.isElement(__in, sObjects__typeInfo)) {
			setSObjects((com.sforce.soap.enterprise.sobject.SObject[]) __typeMapper.readObject(__in,
					sObjects__typeInfo, com.sforce.soap.enterprise.sobject.SObject[].class));
		}
	}
