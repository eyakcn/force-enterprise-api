...
public class InvalidateSessions_element implements com.sforce.ws.bind.XMLizable {
	...
	/**
	 * * element : sessionIds of type {http://www.w3.org/2001/XMLSchema}string * java
	 * type: java.lang.String[]
	 */
	private static final com.sforce.ws.bind.TypeInfo sessionIds__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "sessionIds", "http://www.w3.org/2001/XMLSchema", "string", 0, -1, true);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.isElement(__in, sessionIds__typeInfo)) {
			setSessionIds((java.lang.String[]) __typeMapper.readObject(__in, sessionIds__typeInfo,
