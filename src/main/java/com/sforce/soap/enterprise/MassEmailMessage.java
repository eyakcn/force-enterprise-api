...
public class MassEmailMessage extends com.sforce.soap.enterprise.Email {
	...
	/**
	 * * element : description of type {http://www.w3.org/2001/XMLSchema}string * java
	 * type: java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo description__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "description", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
	...
	/**
	 * * element : targetObjectIds of type {urn:enterprise.soap.sforce.com}ID * java type:
	 * java.lang.String[]
	 */
	private static final com.sforce.ws.bind.TypeInfo targetObjectIds__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "targetObjectIds", "urn:enterprise.soap.sforce.com", "ID", 0, 250, true);
	...
	/**
	 * * element : whatIds of type {urn:enterprise.soap.sforce.com}ID * java type:
	 * java.lang.String[]
	 */
	private static final com.sforce.ws.bind.TypeInfo whatIds__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "whatIds", "urn:enterprise.soap.sforce.com", "ID", 0, 250, true);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.verifyElement(__in, description__typeInfo)) {
			setDescription((java.lang.String) __typeMapper.readString(__in, description__typeInfo,
					java.lang.String.class));
		}
		__in.peekTag();
		if (__typeMapper.isElement(__in, targetObjectIds__typeInfo)) {
			setTargetObjectIds((java.lang.String[]) __typeMapper.readObject(__in, targetObjectIds__typeInfo,
					java.lang.String[].class));
		}
		__in.peekTag();
