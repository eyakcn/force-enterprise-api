...
public class DescribeGlobalResult implements com.sforce.ws.bind.XMLizable {
	...
	/**
	 * * element : encoding of type {http://www.w3.org/2001/XMLSchema}string * java type:
	 * java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo encoding__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "encoding", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
	...
	/**
	 * * element : maxBatchSize of type {http://www.w3.org/2001/XMLSchema}int * java type:
	 * int
	 */
	private static final com.sforce.ws.bind.TypeInfo maxBatchSize__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "maxBatchSize", "http://www.w3.org/2001/XMLSchema", "int", 1, 1, true);
	...
	/**
	 * * element : sobjects of type
	 * {urn:enterprise.soap.sforce.com}DescribeGlobalSObjectResult * java type:
	...
	private static final com.sforce.ws.bind.TypeInfo sobjects__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "sobjects", "urn:enterprise.soap.sforce.com",
			"DescribeGlobalSObjectResult", 0, -1, true);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.isElement(__in, sobjects__typeInfo)) {
			setSobjects((com.sforce.soap.enterprise.DescribeGlobalSObjectResult[]) __typeMapper.readObject(__in,
					sobjects__typeInfo, com.sforce.soap.enterprise.DescribeGlobalSObjectResult[].class));
		}
	}
