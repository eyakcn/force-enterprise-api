...
public class ProcessRequest implements com.sforce.ws.bind.XMLizable {
	...
	/**
	 * * element : comments of type {http://www.w3.org/2001/XMLSchema}string * java type:
	 * java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo comments__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "comments", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
	...
	/**
	 * * element : nextApproverIds of type {urn:enterprise.soap.sforce.com}ID * java type:
	 * java.lang.String[]
	 */
	private static final com.sforce.ws.bind.TypeInfo nextApproverIds__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "nextApproverIds", "urn:enterprise.soap.sforce.com", "ID", 0, -1, true);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.isElement(__in, nextApproverIds__typeInfo)) {
			setNextApproverIds((java.lang.String[]) __typeMapper.readObject(__in, nextApproverIds__typeInfo,
