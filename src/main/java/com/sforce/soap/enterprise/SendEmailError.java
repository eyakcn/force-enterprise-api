...
public class SendEmailError implements com.sforce.ws.bind.XMLizable {
	...
	/**
	 * * element : fields of type {http://www.w3.org/2001/XMLSchema}string * java type:
	 * java.lang.String[]
	 */
	private static final com.sforce.ws.bind.TypeInfo fields__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "fields", "http://www.w3.org/2001/XMLSchema", "string", 0, -1, true);
	...
	/**
	 * * element : message of type {http://www.w3.org/2001/XMLSchema}string * java type:
	 * java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo message__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "message", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
	...
	/**
	 * * element : statusCode of type {urn:enterprise.soap.sforce.com}StatusCode * java
	 * type: com.sforce.soap.enterprise.StatusCode
	 */
	private static final com.sforce.ws.bind.TypeInfo statusCode__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "statusCode", "urn:enterprise.soap.sforce.com", "StatusCode", 1, 1, true);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.verifyElement(__in, statusCode__typeInfo)) {
			setStatusCode((com.sforce.soap.enterprise.StatusCode) __typeMapper.readObject(__in, statusCode__typeInfo,
					com.sforce.soap.enterprise.StatusCode.class));
		}
		__in.peekTag();
