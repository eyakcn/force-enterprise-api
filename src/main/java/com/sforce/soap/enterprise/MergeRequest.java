...
public class MergeRequest implements com.sforce.ws.bind.XMLizable {
	 ...
	 */
	private static final com.sforce.ws.bind.TypeInfo masterRecord__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "masterRecord", "urn:sobject.enterprise.soap.sforce.com", "sObject", 1,
			1, true);
	...
	/**
	 * * element : recordToMergeIds of type {urn:enterprise.soap.sforce.com}ID * java
	 * type: java.lang.String[]
	 */
	private static final com.sforce.ws.bind.TypeInfo recordToMergeIds__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "recordToMergeIds", "urn:enterprise.soap.sforce.com", "ID", 1, -1, true);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.verifyElement(__in, masterRecord__typeInfo)) {
			setMasterRecord((com.sforce.soap.enterprise.sobject.SObject) __typeMapper.readObject(__in,
					masterRecord__typeInfo, com.sforce.soap.enterprise.sobject.SObject.class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, recordToMergeIds__typeInfo)) {
			setRecordToMergeIds((java.lang.String[]) __typeMapper.readObject(__in, recordToMergeIds__typeInfo,
