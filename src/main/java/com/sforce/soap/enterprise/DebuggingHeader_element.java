...
public class DebuggingHeader_element extends com.sforce.ws.bind.SoapHeaderObject implements com.sforce.ws.bind.XMLizable {
	...
	/**
	 * * element : debugLevel of type {urn:enterprise.soap.sforce.com}DebugLevel * java
	 * type: com.sforce.soap.enterprise.DebugLevel
	 */
	private static final com.sforce.ws.bind.TypeInfo debugLevel__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "debugLevel", "urn:enterprise.soap.sforce.com", "DebugLevel", 1, 1, true);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.verifyElement(__in, debugLevel__typeInfo)) {
			setDebugLevel((com.sforce.soap.enterprise.DebugLevel) __typeMapper.readObject(__in, debugLevel__typeInfo,
					com.sforce.soap.enterprise.DebugLevel.class));
		}
	}
