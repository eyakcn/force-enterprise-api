...
public class GetUserInfoResponse_element implements com.sforce.ws.bind.XMLizable {
	...
	/**
	 * * element : result of type {urn:enterprise.soap.sforce.com}GetUserInfoResult * java
	 * type: com.sforce.soap.enterprise.GetUserInfoResult
	 */
	private static final com.sforce.ws.bind.TypeInfo result__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "result", "urn:enterprise.soap.sforce.com", "GetUserInfoResult", 1, 1,
			true);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.verifyElement(__in, result__typeInfo)) {
			setResult((com.sforce.soap.enterprise.GetUserInfoResult) __typeMapper.readObject(__in, result__typeInfo,
					com.sforce.soap.enterprise.GetUserInfoResult.class));
		}
	}
