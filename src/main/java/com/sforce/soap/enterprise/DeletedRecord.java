...
public class DeletedRecord implements com.sforce.ws.bind.XMLizable {
	...
	/**
	 * * element : deletedDate of type {http://www.w3.org/2001/XMLSchema}dateTime * java
	 * type: java.util.Calendar
	 */
	private static final com.sforce.ws.bind.TypeInfo deletedDate__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "deletedDate", "http://www.w3.org/2001/XMLSchema", "dateTime", 1, 1, true);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
		...
		if (__typeMapper.verifyElement(__in, deletedDate__typeInfo)) {
			setDeletedDate((java.util.Calendar) __typeMapper.readObject(__in, deletedDate__typeInfo,
